<?php
    ...
    $ambil_spaj_terahkir = mysql_query("SELECT MAX(no_spaj) AS max_spaj FROM nasabah");
...
<html>
    ...
    <body>
        ...
        <div id="outer">
            <div id="header">
            <a href="#" id="daftar_nasabah">Pendaftaran Nasabah</a>     
               <form method="POST" id="fm_nasabah" action="proses_spaj.php">
               <table>
                   <tr>
                       <td>No. SPAJ</td>
                       <td>:</td>
